        ...
        <div id="main" class="container">
            <div class="row">
                <div class="span12">
                    ...
                    <div id='cstats'>
                        <h3>IP Traffic Daily History</h3>
                        <div class='section'>
                            <table id='daily-grid' class='table table-striped table-condensed table-bordered'></table>
                        </div>
                    ...
                    <br /><input type='button' value='Refresh' onclick='reloadPage()' class='btn'>
