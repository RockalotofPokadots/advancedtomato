    ...
    <head>
        ...
        <script type='text/javascript'>
            ...
            function ethstates()
            {
                ...
                var code = '<h3>Ethernet Ports State <small><a href="basic-network.asp">(Configure)</a></small></h3>';
                code += '<div id="ethPorts"><div class="ethCable"></div>';
        ...
        <div id="main" class="container fixtables">
            <div class="row">
                <div class="span12">
                    ...
                    <div class="section" id="ports"></div>
