        ...
        <script type="text/javascript">
            ...
            function toggleVisibility(whichone) {
                if(E('sesdiv' + whichone).style.display=='') {
                    ...
                    cookie.set('splashd_' + whichone + '_vis', 0);
                } else {
                    E('sesdiv' + whichone).style.display='';
                    E('sesdiv' + whichone + 'showhide').innerHTML='(Click here to hide)';
                    cookie.set('splashd_' + whichone + '_vis', 1);
                }
            }

            function init() {
                var c;
                if (((c = cookie.get('splashd_notes_vis')) != null) && (c == '1')) {
        ...
        <div id="main" class="container">
            <div class="row">
                <div class="span12">
                    ...
                    <h3>User Guide <small><i><a href="javascript:toggleVisibility('notes');"><span id="sesdivnotesshowhide">(Click here to show)</span></a></i></small></h3>
