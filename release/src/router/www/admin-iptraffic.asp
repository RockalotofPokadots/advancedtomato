                ...
                <div class="span12">
                    ...
                    <div class="section" id="backup-section">
                        <div class="input-append">
                            <script type="text/javascript">
                                W("<input class='span4' type='text' size='40' maxlength='64' id='backup-name' name='backup_name' onchange='backupNameChanged()' value='tomato_cstats_" + nvram.et0macaddr.replace(/:/g, '').toLowerCase() + "'>");
                            </script>
                            <span class="add-on">.gz</span>

                            <button name="f_backup_button" id="backup-button" onclick="backupButton(); return false;" class="btn">Backup</button>
                        </div>
                    </div>
                    <br>
