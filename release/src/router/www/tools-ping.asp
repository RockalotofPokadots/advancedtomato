        ...
        <div id="main" class="container">
            <div class="row">
                <div class="span12">
                        ...
                        <script type='text/javascript'>
                            createFieldTable('', [
                                    { title: 'Address', name: 'f_addr', type: 'text', maxlen: 64, size: 32, value: '',
                                        suffix: ' <button type="submit" value="Ping" onclick="ping()" id="pingb" class="btn">Ping</button>' },
                    ...
                    <table id='tp-grid' class='table table-striped table-condensed table-bordered'></table>
                    <pre id='stats'></pre>
