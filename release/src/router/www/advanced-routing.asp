            ...
            <div class="row">
                <div class="span12">
                    ...
                    <form id="_fom" method="post" action="tomato.cgi">
                        ...
                        <div class="section">
                            <table class="table table-striped table-condensed table-bordered langrid" id="ara-grid"></table>
                        </div>

                        <h3>Static Routing Table</h3>
                        <div class="section">
                            <table class="table table-striped table-condensed table-bordered langrid" id="ars-grid"></table>
                        </div>
