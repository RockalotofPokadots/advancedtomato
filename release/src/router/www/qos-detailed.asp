...
<html lang="en">
    <head>
        ...
        <script type="text/javascript">
            ...
            //	<% nvram('at_update,tomatoanon_answer,qos_classnames,lan_ipaddr,lan1_ipaddr,lan2_ipaddr,lan3_ipaddr,lan_netmask,lan1_netmask,lan2_netmask,lan3_netmask,t_hidelr'); %>
        ...
        <div id="main" class="container">
            <div class="row">
                <div class="span12">
                    ...
                    <h3 id="stitle" onclick="document.location='qos-graphs.asp'" style="cursor:pointer">Details <span id="numtotalconn"></span></h3>
                    <div class="section">
