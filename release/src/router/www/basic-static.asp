...
<html lang="en">
    <head>
        ...
        <script type="text/javascript">
            ...
            //	<% nvram("at_update,tomatoanon_answer,lan_ipaddr,lan_netmask,dhcpd_static,dhcpd_startip,dhcpd_static_only,cstats_include,arpbind_listed"); %>
            ...
            sg.setup = function() {
                this.init('bs-grid', 'sort', 250, [
                        { multi: [ { type: 'text', maxlen: 17, class: 'input-medium' }, { type: 'text', maxlen: 17, class: 'input-medium' } ] },
            ...
            <div class="row">
                <div class="span12">
                    ...
                    <form id="_fom" method="post" action="tomato.cgi">
                        ...
                        <h3>Static DHCP/ARP &amp; Bandwidth Monitoring of LAN Clients</h3>
                        <div class="section">
                            <table class="table table-striped table-condensed table-bordered" id="bs-grid"></table>
                        </div>
