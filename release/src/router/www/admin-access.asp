                    ...
                    <form id="_fom" method="post" action="tomato.cgi">
                            ...
                            <script type="text/javascript">
                                var m = [
                                    ...
                                    { title: 'Color Scheme', name: 'web_css', type: 'select',
                                        options: [['tomato','AdvancedTomato'],['css/clean','AT - Clean Theme'],['ext/custom','Custom (ext/custom.css)'], ['online', 'On-line from TTB']], value: nvram.web_css },
                                    ...
                                    { title: 'Navigation Style', name: 'at_navigation', type: 'select', options: [['nav-top','Top (Drop-down)'],['nav-left','Metro Left Side']], suffix: '&nbsp;<small>(Left navi is only for tablets & higher displays)</small>',
                                        value:  nvram.at_navigation },
                                ];
                        ...
                        <div class="section">
                            <script type="text/javascript">
                                ...
                                W('<input class="btn" type="button" value="' + (sdup ? 'Stop' : 'Start') + ' Now" onclick="toggle(\'sshd\', sdup)" id="_sshd_button">');
                            </script>
                        </div>
                        <br />
                        <h3>Telnet Daemon</h3>
                        <div class="section">
                            <script type="text/javascript">
                                ...
                                W('<input class="btn" type="button" value="' + (tdup ? 'Stop' : 'Start') + ' Now" onclick="toggle(\'telnetd\', tdup)" id="_telnetd_button">');
                            </script>
                        </div>
                        <br />
