        ...
        <div id="main" class="container">
            <div class="row">
                <div class="span12">
                    ...
                    <div class='section'>
                        <table id='survey-grid' class='table table-striped table-condensed table-bordered'></table>
                        <div id='survey-msg'></div>
                        <div id='survey-controls'>
                            <img src="spin.gif" id="refresh-spinner">
                            <script type='text/javascript'>
                                genStdTimeList('expire-time', 'Auto Expire', 1);
                                genStdTimeList('refresh-time', 'Auto Refresh', 1);
                            </script>
                            <input style="margin-top: -11px;" type="button" value="Refresh" onclick="ref.toggle()" id="refresh-button" class='btn'>
                        </div>
